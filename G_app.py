...
R_model=pickle.load(open("/storage/emulated/0/Download/RealEstate-Project/Linear_model.pkl","rb"))
#loading classifier best model
C_model=pickle.load(open("/storage/emulated/0/Download/RealEstate-Project/classifier_model.pkl","rb"))
app=Flask( __name__ )
