...
def work():
    ...
    if request.method=="POST":
        ...
        feature1=np.array([[State,PropertyType,Bedrooms,Bathrooms,
                            Toilets,SizeSqm,Floors,AgeYears,ParkingSpots,SwimmingPool,
                            Gym,Security,Furnished,Estate,YearBuilt,Total_str,Age_distance,
                            Floor_parking_index,Comfort]])
        ...
        feature2=np.array([[State,PropertyType,Bedrooms,Bathrooms,Toilets,SizeSqm,Floors,
                            AgeYears,ParkingSpots,SwimmingPool,Gym,Security,Furnished,Estate,
                            YearBuilt,Total_str,Price_index,Price_Size,Age_distance,Floor_parking_index,
                            Price_INdex,Comfort]])
